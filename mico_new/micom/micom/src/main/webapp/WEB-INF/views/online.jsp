          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body" >
                  <table id="onlinetable" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Name</th>
                    ...
                    <tbody>
                      <c:forEach items="${onlinelist}" var="ol">
                      <tr>
                        <c:if test="${ol.id >= 100000 && ol.id <= 72057594037927935}">
                        <td><a href="/userinfo/${ol.id}"><c:out value="${ol.id}"/></a></td>
                        </c:if>
                        <c:if test="${!(ol.id >= 100000 && ol.id <= 72057594037927935)}">
                        <td><a href="/devinfo/${ol.id}"><c:out value="${ol.id}"/></a></td>
                        </c:if>
                        <td><c:out value="${ol.name}" /> </td>
                        <td><c:out value="${ol.address}" />
                          <td><c:out value="${ol.macAddr}" /> </td>
                          <td><c:out value="${ol.sessionKey}" /> </td>
                          <td><c:out value="${ol.loginserverid}" /> </td>
                          <td><c:out value="${ol.time}" /> </td>
                        </tr>
                        </c:forEach>
                      </tbody>
                    </table>
